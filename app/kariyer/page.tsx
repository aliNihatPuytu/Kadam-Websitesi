        ...
        <SectionWrapper className="py-24 lg:py-32 bg-white">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
            <FadeIn className="text-center mb-16">
              <h2 className="font-heading font-bold text-3xl md:text-4xl text-[#2B2B2B] mb-4">
                {locale === 'tr' ? 'KADAM\'da Çalışmak' : 'Working at KADAM'}
              </h2>
              <p className="text-lg text-[#2B2B2B]/70 max-w-2xl mx-auto">
                {locale === 'tr' 
                  ? 'KADAM ailesinin bir parçası olmanın avantajlarını keşfedin.'
                  : 'Discover the advantages of being part of the KADAM family.'
                }
              </p>
            </FadeIn>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {benefits.map((benefit, index) => {
                ...
                return (
                  ...
                  >
                    <div className="w-16 h-16 mx-auto rounded-full bg-[#8C1D18]/10 flex items-center justify-center mb-4">
                      <Icon className="w-8 h-8 text-[#8C1D18]" />
                    </div>
                    <h3 className="font-heading font-semibold text-xl text-[#2B2B2B] mb-2">
